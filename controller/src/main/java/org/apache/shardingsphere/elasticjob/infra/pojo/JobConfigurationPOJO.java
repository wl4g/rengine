...
/**
 * ControllerLog configuration POJO.
 */
@Getter
@Setter
public final class JobConfigurationPOJO {
    ...
    public JobConfiguration toJobConfiguration() {
        ...
        // .jobListenerTypes(jobListenerTypes.toArray(new String[0]))
    ...
    public static JobConfigurationPOJO fromJobConfiguration(final JobConfiguration jobConfiguration) {
        ...
        jobConfiguration.getExtraConfigurations()
                .stream()
                .map(each -> YamlConfigurationConverterFactory.findConverter((Class<JobExtraConfiguration>) each.getClass())
                        .orElseThrow(() -> new YamlConfigurationConverterNotFoundException(each.getClass()))
                        .convertToYamlConfiguration(each))
                .forEach(result.getJobExtraConfigurations()::add);
