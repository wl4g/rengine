@echo off
rem Copyright (c) 2017 ~ 2025, the original authors individual Inc,
rem All rights reserved. Contact us James Wong <jameswong1376@gmail.com>
rem
...
rem Global define.
rem
set MAIN_JAR_NAME=rengine-scheduler
set MAIN_CLASS=com.wl4g.RengineScheduler
...
IF NOT EXIST %LIBS_DIR%\%MAIN_JAR_NAME%.jar (
	echo "No %MAIN_JAR_NAME%.jar starter, or path error."
	rem For wait pause.
	pause
)
