...
import com.wl4g.rengine.scheduler.config.SchedulerProperties.SimpleHttpScrapeJobProperties;
import com.wl4g.rengine.scheduler.config.SchedulerProperties.SimpleJdbcScrapeJobProperties;
import com.wl4g.rengine.scheduler.config.SchedulerProperties.SimpleRedisScrapeJobProperties;
import com.wl4g.rengine.scheduler.config.SchedulerProperties.SimpleSSHScrapeJobProperties;
import com.wl4g.rengine.scheduler.config.SchedulerProperties.SimpleTcpScrapeJobProperties;
import com.wl4g.rengine.scheduler.util.ExpressionVariables;
...
public abstract class CollectJobExecutor<P extends CollectJobExecutor.JobParamBase> implements TypedJobItemExecutor {
    ...
    protected final SchedulerProperties config;
    ...
    public CollectJobExecutor() {
        this.config = CDI.current().select(SchedulerProperties.class).get();
