...
import com.wl4g.rengine.evaluator.execution.engine.GroovyScriptEngine;
import com.wl4g.rengine.evaluator.execution.engine.IEngine;

/**
 * {@link AbstractWorkflowExecution}
 * 
 * @author James Wong
 * @version 2022-09-17
 * @since v1.0.0
 */
public abstract class AbstractWorkflowExecution implements IExecution {
    ...
    protected IEngine getEngine(EvaluationEngine engine) {
        switch (engine) {
        case GROOVY:
