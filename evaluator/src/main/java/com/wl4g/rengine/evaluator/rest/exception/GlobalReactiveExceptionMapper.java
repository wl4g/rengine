...
//// @ApplicationScoped
// @Singleton
// public class GlobalReactiveExceptionMapper implements
/// ResteasyReactiveExceptionMapper<Throwable> {
//
// @Inject
...
//
// @Override
// public Response toResponse(Throwable th, ServerRequestContext context) {
// return wrapExceptionToResponse(th);
// }
//
