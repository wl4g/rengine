...
import com.wl4g.rengine.server.constants.RengineWebConstants;
import com.wl4g.rengine.server.minio.MinioClientAutoConfiguration;
...
public class RengineAutoConfiguration {
    ...
    @Bean
    @ConfigurationProperties(prefix = RengineWebConstants.CONF_PREFIX)
