...
public class ElasticJobBootstrapBuilder {
    ...
    public ElasticJobBootstrapBuilder(@NotNull RengineSchedulerProperties config,
    ...
    public Map<String, JobBootstrap> build() {
        return constructJobBootstraps(config, registryCenter, getTracingConfiguration());
    }
    ...
    private KeyValue createRegisterTypedJob(
            ...
            final CoordinatorRegistryCenter registryCenter,
            final TracingConfiguration<?> tracingConfig,
            final BaseJobProperties<? extends JobParamBase> scrapeConfig) {
