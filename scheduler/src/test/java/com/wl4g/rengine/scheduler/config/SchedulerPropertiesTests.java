...
/**
 * {@link SchedulerPropertiesTests}
 * 
 * @author James Wong
 * @version 2022-10-21
 * @since v3.0.0
 */
public class SchedulerPropertiesTests {
    ...
    public void testScrapeJobPropertiesPolymorphismUnmarshal() throws Exception {
        ...
        SchedulerProperties config = new Yaml(new SchedulerYamlConstructor()).loadAs(yaml, SchedulerProperties.class);
