...
public interface UnaryEquator<T> extends BiPredicate<T, T> {
    /**
     * Returns a composed equator that represents a short-circuiting logical AND
     * of this equator and another. When evaluating the composed equator, if
     * this equator is {@code false}, then the {@code other} equator is not
     * evaluated.
     *
     * @param other
     *            The other (never {@code null} equator
     ...
     * Returns a composed equator that represents a short-circuiting logical AND
     * of this equator and another. When evaluating the composed equator, if
     * this equator is {@code true}, then the {@code other} equator is not
     * evaluated.
     *
     * @param other
     *            The other (never {@code null} equator
    ...
    /**
     * Converts a {@link Comparator} into a {@link UnaryEquator} that returns
     * {@code true} if the comparator returns zero
     *
     * @param <T>
     *            Type of entity
     * @param c
     *            The (never {@code null}) comparator
