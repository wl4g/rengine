...
public final class ExceptionUtils {
    ...
    /**
     * @param t
     *            The original {@link Throwable} - ignored if {@code null}
     * @return If {@link Throwable#getCause()} is non-{@code null} then the
     *         cause, otherwise the original exception - {@code null} if the
     *         original exception was {@code null}
     */
    ...
    /**
     * Attempts to get to the &quot;effective&quot; exception being thrown, by
     * taking care of some known exceptions that wrap the original thrown one.
     *
     * @param t
     *            The original {@link Throwable} - ignored if {@code null}
...
//        }
     ...
     * @param peelThrowable
     *            Whether to determine the root cause by &quot;peeling&quot; any
