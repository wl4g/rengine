...
public final class MapEntryUtils {
     ...
     *
     * @param <K>
     *            Original map key type
     * @param <V>
     *            Original map value type
     * @param <M>
     *            Flipped map type
     * @param map
     *            The original map to flip
     * @param mapCreator
     *            The creator of the target map
     * @param allowDuplicates
     *            Whether to ignore duplicates on flip
     * @return The flipped map result
     * @throws IllegalArgumentException
     *             if <tt>allowDuplicates</tt> is {@code false} and a duplicate
     *             value found in the original map.
     */
     ...
     *            The value type
     * @param <M>
     *            The result {@link Map} type
     * @param keyMapper
     *            The {@link Function} that generates a key for a given value.
     *            If the returned key is {@code null} then the value is not
     *            mapped
     * @param mapCreator
     *            The {@link Supplier} used to create/retrieve the result map -
     *            provided non-empty group of values
     * @param values
     *            The values to be mapped
     * @return The resulting {@link Map} - <B>Note:</B> no validation is made to
     *         ensure that 2 (or more) values are not mapped to the same key
     */
    public static <K, V, M extends Map<K, V>> M mapValues(
            Function<? super V, ? extends K> keyMapper,
            Supplier<? extends M> mapCreator,
