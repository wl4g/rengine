...
public abstract class BasePath<T extends BasePath<T, FS>, FS extends BaseFileSystem<T>> implements Path {
    ...
    public boolean startsWith(Path other) {
        ...
        return Objects.equals(p1.getFileSystem(), p2.getFileSystem()) && Objects.equals(p1.root, p2.root)
    ...
    public T relativize(Path other) {
        ...
        List<String> extraNamesInOther = (p2.names.size() <= sharedSubsequenceLength) ? Collections.emptyList()
