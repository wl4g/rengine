   ...
   boolean isConnectionAlive(final Connection connection)
   {
      try {
         try {
            ...
            System.out.println(">>>>validationTimeout: "+ validationTimeout);
            System.out.println(">>>>validationSeconds: "+ validationSeconds);
            System.out.println(">>>>isUseJdbc4Validation: "+ isUseJdbc4Validation);
            ...
            try (Statement statement = connection.createStatement()) {
               if (isNetworkTimeoutSupported != TRUE) {
                   System.out.println(">>>>setQueryTimeout: "+ validationSeconds);
                  setQueryTimeout(statement, validationSeconds);
               }

               boolean valid = statement.execute(config.getConnectionTestQuery());
               System.out.println(">>>>statement.execute: "+ valid);
            }
         }
         finally {
            setNetworkTimeout(connection, networkTimeout);
            System.out.println(">>>>isNetworkTimeoutSupported: "+ isNetworkTimeoutSupported);
            System.out.println(">>>>networkTimeout: "+ networkTimeout);
            System.out.println(">>>>isIsolateInternalQueries: "+ isIsolateInternalQueries);
