   ...
   public Connection getConnection(final long hardTimeout) throws SQLException
   {
      ...
      try {
         ...
         do {
            ...
            System.out.println(">>>>poolEntry.isMarkedEvicted(): "+ poolEntry.isMarkedEvicted());
            System.out.println(">>>>poolEntry.lastAccessed: "+ poolEntry.lastAccessed);
            System.out.println(">>>>elapsedMillis(poolEntry.lastAccessed, now): "+ elapsedMillis(poolEntry.lastAccessed, now));
            System.out.println(">>>>aliveBypassWindowMs: "+ aliveBypassWindowMs);
            System.out.println(">>>>poolEntry.connection: "+ poolEntry.connection);
            System.out.println(">>>>!isConnectionAlive(poolEntry.connection): "+ !isConnectionAlive(poolEntry.connection));
            ...
            System.out.println(">>>>timeout=hardTimeout - elapsedMillis(startTime): "+ timeout);
         } while (timeout > 0L);
