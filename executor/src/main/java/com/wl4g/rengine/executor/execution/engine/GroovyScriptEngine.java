...
//import com.wl4g.rengine.common.exception.EvaluationException2;
...
//            for (ObjectResource script : loadScriptResources(UploadType.LIBJS, scenes, true)) {
...
//                    }
//                } catch (Throwable e) {
//                    throw new EvaluationException2(workflowExecuteRequest.getRequestId(), scenes.getScenesCode(),
//                            format("Failed to load groovy dependency '%s'", scriptName), e);
//                }
//            }
//
//            // TODO
//            final String result = mainFunction.apply(newScriptContext(workflowExecuteRequest));
