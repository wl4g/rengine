...
@CustomLog
@Singleton
public class GraalRScriptEngine extends GraalBaseScriptEngine {
    ...
    // see:https://www.graalvm.org/22.2/reference-manual/r/Interoperability/
    protected GraalPolyglotManager createGraalPolyglotManager() {
        try {
            log.info("Initialzing graal R script engine ...");
            /**
             * TODO </br>
             ...
             */
            return GraalPolyglotManager.newDefaultForR(DEFAULT_EXECUTOR_SCRIPT_CACHE_DIR, getSharedSandboxPolyglotFileSystem(),
