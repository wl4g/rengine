...
public class ScriptRedisLockClient {
    ...
    public @HostAccess.Export ScriptRedisLockClient(@NotNull final RedisDataSource redisDS) {
        this.jedisLockManager = buildJedisLockManagerWithBlockingReactiveRedis(redisDS);
    }
    ...
    public static JedisLockManager buildJedisLockManagerWithBlockingReactiveRedis(final @NotNull RedisDataSource redisDS) {
