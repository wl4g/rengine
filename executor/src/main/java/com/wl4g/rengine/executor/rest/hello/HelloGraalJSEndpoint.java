 ...
 */
package com.wl4g.rengine.executor.rest.hello;
...
public class HelloGraalJSEndpoint {
    ...
    @POST
    @Path("/execute")
    public RespBase<Object> execute(TestJavascriptExecution model) {
        ...
        try (ContextWrapper context = jsScriptEngine.getGraalPolyglotManager().getContext(null);) {
            ...
            //                .build(),
            //        "BsonEntitySerializers serious alarm occurs when the device temperature is greater than 52℃", singletonMap("objId", "1010012"));
            // @formatter:on
