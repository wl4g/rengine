...
public class JDBCSourceFacade implements DataSourceFacade {
    ...
    public List<Map<String, Object>> findList(final @NotBlank String sql, final Object... params) throws SQLException {
        ...
        try (Connection conn = helper.getDataSource().getConnection();) {
            final List<Map<String, Object>> result = MeterUtil.timer(execution_sdk_datasource_time, dataSourceName,
                    DataSourceType.JDBC, METHOD_FIND_LIST,
                    () -> helper.getQueryRunner().query(conn, sql, new MapListHandler(), params));

            MeterUtil.counter(execution_sdk_datasource_success, dataSourceName, DataSourceType.JDBC, METHOD_FIND_LIST);
            return result;
        } catch (Throwable e) {
            MeterUtil.counter(execution_sdk_datasource_failure, dataSourceName, DataSourceType.JDBC, METHOD_FIND_LIST);
            throw e;
        }
    }
    ...
    public Map<String, Object> insert(final @NotBlank String sql, final Object... params) throws SQLException {
        ...
        try (Connection conn = helper.getDataSource().getConnection();) {
            ...
            MeterUtil.counter(execution_sdk_datasource_failure, dataSourceName, DataSourceType.JDBC, METHOD_INSERT);
            throw e;
        }
    }
    ...
    public int[] insertBatch(final @NotBlank String sql, final Object[][] params) throws SQLException {
        ...
        try (Connection conn = helper.getDataSource().getConnection();) {
            ...
            MeterUtil.counter(execution_sdk_datasource_success, dataSourceName, DataSourceType.JDBC, METHOD_INSERT_BATCH);
            return result;
        } catch (Throwable e) {
            MeterUtil.counter(execution_sdk_datasource_failure, dataSourceName, DataSourceType.JDBC, METHOD_INSERT_BATCH);
            throw e;
        }
    }
    ...
    public int update(final @NotBlank String sql, Object... params) throws SQLException {
        ...
        try (Connection conn = helper.getDataSource().getConnection();) {
            ...
            MeterUtil.counter(execution_sdk_datasource_failure, dataSourceName, DataSourceType.JDBC, METHOD_UPDATE);
            throw e;
        }
    }
    ...
    public int[] batch(final @NotBlank String sql, final Object[][] params) throws SQLException {
        ...
        try (Connection conn = helper.getDataSource().getConnection();) {
            ...
            MeterUtil.counter(execution_sdk_datasource_failure, dataSourceName, DataSourceType.JDBC, METHOD_BATCH);
            throw e;
        }
    }
