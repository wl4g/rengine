 ...
 *
 * <p>
 * This context only exposes the functionality needed by the pattern process
 * function and iterative condition function. Consequently, state access,
...
public class CepRuntimeContext implements RuntimeContext {
    ...
    @Override
    public <T, C> C getBroadcastVariableWithInitializer(final String name, final BroadcastVariableInitializer<T, C> initializer) {
        throw new UnsupportedOperationException("Broadcast variables are not supported.");
    }
