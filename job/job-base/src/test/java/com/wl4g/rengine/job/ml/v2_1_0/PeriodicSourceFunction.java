...
public class PeriodicSourceFunction implements SourceFunction<Row> {
    ...
    /**
     * @param interval
     *            The time interval in milliseconds to collect data into
     *            sourceContext.
     * @param data
     *            The data to be collected. Each element is a list of records to
     *            be collected between two adjacent intervals.
     */
