 ...
 *
 * <p>
 * Each {@link Pattern} can be optional and have a {@link ConsumingStrategy}.
 * Looping and Times also hava an additional inner consuming strategy that is
 * applied between accepted events in the pattern.
 */
public class Quantifier {
    private EnumSet<QuantifierProperty> properties;

    private ConsumingStrategy consumingStrategy;
    ...
    private Quantifier(final ConsumingStrategy consumingStrategy, final QuantifierProperty first,
    ...
    public void combinations() {
        ...
        checkPattern(innerConsumingStrategy != ConsumingStrategy.STRICT,
    ...
    public void consecutive() {
        checkPattern(hasProperty(QuantifierProperty.LOOPING) || hasProperty(QuantifierProperty.TIMES),
    ...
    public void optional() {
        ...
        checkPattern(!(consumingStrategy == ConsumingStrategy.NOT_NEXT || consumingStrategy == ConsumingStrategy.NOT_FOLLOW),
    ...
    public void greedy() {
        ...
        checkPattern(!hasProperty(Quantifier.QuantifierProperty.SINGLE), "Option not applicable to singleton quantifier");
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(properties, that.properties) && consumingStrategy == that.consumingStrategy
    ...
    /**
     * Properties that a {@link Quantifier} can have. Not all combinations are
     * valid.
     */
    ...
    /**
     * Describes strategy for which events are matched in this {@link Pattern}.
    ...
    public static class Times {
        ...
        public boolean equals(Object o) {
            ...
            return from == times.from && to == times.to
                    && ((windowTime == null && times.windowTime == null) || (windowTime != null && times.windowTime != null
