 ...
 */
package com.wl4g.rengine.job.analytic.core.rabbitmq;
...
public abstract class RabbitMQUtil {
    ...
    // // TODO
    // RabbitMQSource<RengineEventAnalyticalModel> source =
    // RabbitMQSource.<RengineEventAnalyticalModel> builder()
