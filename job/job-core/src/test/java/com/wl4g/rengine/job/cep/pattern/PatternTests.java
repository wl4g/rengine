...
public class PatternTests {
    ...
    public void testSimpleKeyedPatternCEP() throws Exception {
        ...
        DataStream<Event> input = env
                .fromElements(new Event(1, "barfoo", 1.0), new Event(2, "start", 2.0), new Event(3, "start", 2.1),
                        new Event(3, "foobar", 3.0), new SubEvent(4, "foo", 4.0, 1.0), new SubEvent(3, "middle", 3.2, 1.0),
                        new Event(42, "start", 3.1), new SubEvent(42, "middle", 3.3, 1.2), new Event(5, "middle", 5.0),
                        new SubEvent(2, "middle", 6.0, 2.0), new SubEvent(7, "bar", 3.0, 3.0), new Event(42, "42", 42.0),
                        new Event(3, "end", 2.0), new Event(2, "end", 1.0), new Event(42, "end", 42.0))
    ...
    public void testSimplePatternEventTime() throws Exception {
        ...
        // (Event, timestamp)
        DataStream<Event> input = env
                .fromElements(Tuple2.of(new Event(1, "start", 1.0), 5L), Tuple2.of(new Event(2, "middle", 2.0), 1L),
                        Tuple2.of(new Event(3, "end", 3.0), 3L), Tuple2.of(new Event(4, "end", 4.0), 10L),
    ...
    public void testSimpleKeyedPatternEventTime() throws Exception {
        ...
        // (Event, timestamp)
        DataStream<Event> input = env
                .fromElements(Tuple2.of(new Event(1, "start", 1.0), 5L), Tuple2.of(new Event(1, "middle", 2.0), 1L),
                        Tuple2.of(new Event(2, "middle", 2.0), 4L), Tuple2.of(new Event(2, "start", 2.0), 3L),
                        Tuple2.of(new Event(1, "end", 3.0), 3L), Tuple2.of(new Event(3, "start", 4.1), 5L),
                        Tuple2.of(new Event(1, "end", 4.0), 10L), Tuple2.of(new Event(2, "end", 2.0), 8L),
                        Tuple2.of(new Event(1, "middle", 5.0), 7L), Tuple2.of(new Event(3, "middle", 6.0), 9L),
    ...
    public void testSimplePatternWithSingleState() throws Exception {
        ...
        Pattern<Tuple2<Integer, Integer>, ?> pattern = Pattern.<Tuple2<Integer, Integer>> begin("start")
        ...
        DataStream<Tuple2<Integer, Integer>> result = pStream
                .select(new PatternSelectFunction<Tuple2<Integer, Integer>, Tuple2<Integer, Integer>>() {
                    @Override
    ...
    public void testProcessingTimeWithWindow() throws Exception {
        ...
        DataStream<Integer> result = CEP.pattern(input, pattern)
                .inProcessingTime()
                .select(new PatternSelectFunction<Integer, Integer>() {
                    @Override
    ...
    public void testTimeoutHandling() throws Exception {
        ...
        // (Event, timestamp)
        DataStream<Event> input = env
                .fromElements(Tuple2.of(new Event(1, "start", 1.0), 1L), Tuple2.of(new Event(1, "middle", 2.0), 5L),
                        Tuple2.of(new Event(1, "start", 2.0), 4L), Tuple2.of(new Event(1, "end", 2.0), 6L))
                .assignTimestampsAndWatermarks(new AssignerWithPunctuatedWatermarks<Tuple2<Event, Long>>() {
        ...
        DataStream<Either<String, String>> result = CEP.pattern(input, pattern)
                .select(new PatternTimeoutFunction<Event, String>() {
                    @Override
        ...
        List<Either<String, String>> expected = Arrays.asList(Either.Left.of("1.0"), Either.Left.of("2.0"), Either.Left.of("2.0"),
    ...
    public void testSimpleOrFilterPatternCEP() throws Exception {
        ...
        DataStream<Event> input = env.fromElements(new Event(1, "start", 1.0), new Event(2, "middle", 2.0),
                new Event(3, "end", 3.0), new Event(4, "start", 4.0), new Event(5, "middle", 5.0), new Event(6, "end", 6.0));
    ...
    public void testSimplePatternEventTimeWithComparator() throws Exception {
        ...
        DataStream<Event> input = env
                .fromElements(Tuple2.of(new Event(1, "start", 1.0), 5L), Tuple2.of(new Event(2, "middle", 2.0), 1L),
                        Tuple2.of(new Event(3, "end", 3.0), 3L), Tuple2.of(new Event(4, "end", 4.0), 10L),
                        Tuple2.of(new Event(5, "middle", 6.0), 7L), Tuple2.of(new Event(6, "middle", 5.0), 7L),
                        // last element for high final watermark
    ...
    public void testSimpleAfterMatchSkip() throws Exception {
        ...
        DataStream<Tuple2<Integer, String>> input = env.fromElements(new Tuple2<>(1, "a"), new Tuple2<>(2, "a"),
                new Tuple2<>(3, "a"), new Tuple2<>(4, "a"));

        Pattern<Tuple2<Integer, String>, ?> pattern = Pattern
                .<Tuple2<Integer, String>> begin("start", AfterMatchSkipStrategy.skipPastLastEvent())
        ...
        DataStream<Tuple2<Integer, String>> result = pStream
                .select(new PatternSelectFunction<Tuple2<Integer, String>, Tuple2<Integer, String>>() {
                    @Override
    ...
    public void testRichPatternFlatSelectFunction() throws Exception {
        ...
        DataStream<String> result = CEP.pattern(input, pattern)
                .inProcessingTime()
                .flatSelect(new RichPatternFlatSelectFunction<Event, String>() {

                    @Override
                    public void open(Configuration config) {
                        try {
                            getRuntimeContext().getMapState(
                                    new MapStateDescriptor<>("test", LongSerializer.INSTANCE, LongSerializer.INSTANCE));
    ...
    public void testRichPatternSelectFunction() throws Exception {
        ...
        DataStream<String> result = CEP.pattern(input, pattern)
                .inProcessingTime()
                .select(new RichPatternSelectFunction<Event, String>() {
                    @Override
                    public void open(Configuration config) {
                        try {
                            getRuntimeContext().getMapState(
    ...
    public void testFlatSelectSerializationWithAnonymousClass() throws Exception {
        ...
        CEP.pattern(elements, Pattern.begin("BsonEntitySerializers"))
                ...
                .flatSelect(outputTag, new PatternFlatTimeoutFunction<Integer, Integer>() {
                    @Override
                    public void timeout(Map<String, List<Integer>> pattern, long timeoutTimestamp, Collector<Integer> out)
                            throws Exception {
                    }
