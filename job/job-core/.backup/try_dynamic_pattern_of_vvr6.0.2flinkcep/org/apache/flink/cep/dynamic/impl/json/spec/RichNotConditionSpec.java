...
public class RichNotConditionSpec extends RichCompositeConditionSpec {
    public RichNotConditionSpec(@JsonProperty("nestedConditions") List<ConditionSpec> nestedConditions) {
    ...
    public IterativeCondition<?> toIterativeCondition(ClassLoader classLoader) throws Exception {
        return new RichNotCondition(this.getNestedConditions().get(0).toIterativeCondition(classLoader));
    }
