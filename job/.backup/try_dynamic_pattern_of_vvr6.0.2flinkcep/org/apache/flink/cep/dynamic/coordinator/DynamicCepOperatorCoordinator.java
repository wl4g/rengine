...
public class DynamicCepOperatorCoordinator implements OperatorCoordinator {
    ...
    public DynamicCepOperatorCoordinator(OperatorCoordinator.Context context) {
        this(context, null);
    }

    public DynamicCepOperatorCoordinator(OperatorCoordinator.Context context, CountDownLatch blockOnCloseLatch) {
     ...
     * {@link DynamicCepOperatorCoordinator}.
     */
    public static final class Provider implements OperatorCoordinator.Provider {
        ...
        private final SerializableFunction<Context, DynamicCepOperatorCoordinator> factory;

        public Provider(OperatorID operatorId) {
            this(operatorId, DynamicCepOperatorCoordinator::new);
        }

        public Provider(OperatorID operatorId, SerializableFunction<Context, DynamicCepOperatorCoordinator> factory) {
