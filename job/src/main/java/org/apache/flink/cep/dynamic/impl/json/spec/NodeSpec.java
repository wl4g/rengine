...
public class NodeSpec {
    ...
    public NodeSpec(@JsonProperty("name") String name, @JsonProperty("quantifier") QuantifierSpec quantifier,
            @JsonProperty("condition") ConditionSpec condition, @JsonProperty("type") PatternNodeType type) {
        this.name = name;
    ...
    public Pattern<?, ?> toPattern(
        ...
        if (this instanceof GraphSpec) {
            // TODO: should log if AfterMatchSkipStrategy of subgraph diff from
            // the larger graph
