...
public class MenuController {
    ...
    @PreAuthorize("hasAuthority('arn:rengine:sys:menu:query:v1')")
    ...
    @PreAuthorize("hasAuthority('arn:rengine:sys:menu:save:v1')")
    ...
    @PreAuthorize("hasAuthority('arn:rengine:sys:menu:delete:v1')")
