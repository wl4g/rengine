...
abstract class AbstractMergedAnnotation<A extends Annotation> implements MergedAnnotation<A> {
     ...
     *            the attribute name
     * @param type
     *            the type to return (see {@link MergedAnnotation} class
     *            documentation for details)
     * @return the attribute value or {@code null} if the value is not found and
     *         is not required
     * @throws IllegalArgumentException
     *             if the source type is not compatible
     * @throws NoSuchElementException
     *             if the value is required but not found
     */
    @Nullable
     ...
     * <p>
     * If the source is an annotation that is not <em>synthesizable</em>, it
