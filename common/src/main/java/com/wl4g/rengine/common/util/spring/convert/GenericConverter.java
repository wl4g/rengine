 ...
 * {@link #getConvertibleTypes()}). In addition, GenericConverter
 * implementations have access to source/target {@link TypeDescriptor field
 * context} during the type conversion process. This allows for resolving source
 * and target field metadata such as annotations and generics information, which
 * can be used to influence the conversion logic.
 *
 * <p>
...
public interface GenericConverter {
    ...
    /**
     * Return the source and target types that this converter can convert
     * between.
     * <p>
    ...
    final class ConvertiblePair {
        ...
        public ConvertiblePair(Class<?> sourceType, Class<?> targetType) {
            Assert2.notNull(sourceType, "Source type must not be null");
            Assert2.notNull(targetType, "Target type must not be null");
