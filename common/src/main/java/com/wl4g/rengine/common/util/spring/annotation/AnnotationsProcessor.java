...
interface AnnotationsProcessor<C, R> {
     ...
     * 
     * @param context
     *            the context information relevant to the processor
     * @param aggregateIndex
     *            the aggregate index about to be processed
     ...
     *            the context information relevant to the processor
     * @param aggregateIndex
     *            the aggregate index of the provided annotations
     * @param source
     *            the original source of the annotations, if known
     * @param annotations
     *            the annotations to process (this array may contain
     *            {@code null} elements)
     * @return a {@code non-null} result if no further processing is required
     */
    @Nullable
    ...
    /**
     * Get the final result to be returned. By default this method returns the
     * last process result.
     * 
     * @param result
     *            the last early exit result, or {@code null} if none
