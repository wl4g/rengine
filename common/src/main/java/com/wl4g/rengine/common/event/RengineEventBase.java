 ...
 */
@Getter
public abstract class RengineEventBase extends EventObject {
    ...
    /**
     * Construction {@link RengineEventBase} instance.
     * 
     * @param source
     *                      The event source is usually the principal name or IP
     *                      of the authentication request, etc.
     * @param eventType
     * @param message
     */
    public RengineEventBase(@NotNull EventType eventType, @NotNull Object source, @NotBlank String remoteIp,
     ...
     * @param message
     */
    public RengineEventBase(@Min(0) long timestamp, @Nullable EventType eventType, @NotNull Object source,
            @NotBlank String remoteIp, @NotBlank String coordinates, @Nullable String message) {
    ...
    /**
     * Serialize {@link RengineEventBase} object to JSON string.
     * 
     * @param event
     * @return
     */
    @Deprecated
    public static String to(RengineEventBase event) {
        return toJSONString(event.attributes);
    }

    /**
     * DeSerialize to {@link RengineEventBase} object JSON string.
     * 
     * @param json
     *                 {@link RengineEventBase} JSON string.
     * @return
     */
    @SuppressWarnings("serial")
    @Deprecated
    public static RengineEventBase from(String json) {
        ...
        // return parseJSON(json, RengineEventBase.class);
        return new RengineEventBase(timestamp, eventType, source, remoteIp, coordinates, message) {
        };
    }
