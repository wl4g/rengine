...
public interface AnnotationFilter {
     ...
     * {@code java.lang} and {@code org.springframework.lang} packages and their
     * subpackages.
     * <p>
     ...
     * 
     * @see #PLAIN
     * @deprecated as of 5.2.6 since the {@link MergedAnnotations} model always
     *             ignores lang annotations according to the {@link #PLAIN}
     ...
     * 
     * @param typeName
     *            the fully qualified class name of the annotation type to test
     * @return {@code true} if the annotation matches
     */
     ...
     * 
     * @param packages
     *            the annotation packages that should match
