...
public abstract class MergedAnnotationCollectors {
     ...
     * {@link LinkedHashSet} containing
     * {@linkplain MergedAnnotation#synthesize() synthesized} versions.
     * <p>
     ...
     * {@link Annotation} array containing
     * {@linkplain MergedAnnotation#synthesize() synthesized} versions.
     * 
     * @param <A>
     *            the annotation type
     ...
     *            the annotation type
     * @param finisher
     *            the finisher function for the new {@link MultiValueMap}
     * @param adaptations
     *            the adaptations that should be applied to the annotation
     *            values
     * @return a {@link Collector} which collects and synthesizes the
    ...
    public static <A extends Annotation> Collector<MergedAnnotation<A>, ?, MultiValueMap<String, Object>> toMultiValueMap(
        ...
        Characteristics[] characteristics = (isSameInstance(finisher, Function.identity()) ? IDENTITY_FINISH_CHARACTERISTICS
                : NO_CHARACTERISTICS);
        return Collector.of(LinkedMultiValueMap::new, (map, annotation) -> annotation.asMap(adaptations).forEach(map::add),
