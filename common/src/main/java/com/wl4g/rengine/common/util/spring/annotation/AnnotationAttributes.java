 ...
 *
 * <p>
 * Provides 'pseudo-reification' to avoid noisy Map generics in the calling code
 * as well as convenience methods for looking up annotation attributes in a
 * type-safe fashion.
 *
 * @author Chris Beams
 * @author Sam Brannen
...
public class AnnotationAttributes extends LinkedHashMap<String, Object> {
    ...
    /**
     * Create a new, empty {@link AnnotationAttributes} instance with the given
     * initial capacity to optimize performance.
     * 
     ...
     * 
     * @param map
     *            original source of annotation attribute <em>key-value</em>
     *            pairs
     * @see #fromMap(Map)
     */
    ...
    public AnnotationAttributes(Class<? extends Annotation> annotationType) {
        Assert2.notNull(annotationType, "'annotationType' must not be null");
     ...
     *            {@code AnnotationAttributes} instance; never {@code null}
     * @param validated
     *            if the attributes are considered already validated
     * @since 5.2
     */
     ...
     *            {@code AnnotationAttributes} instance; never {@code null}
     * @param classLoader
     *            the ClassLoader to try to load the annotation type on, or
     *            {@code null} to just store the annotation type name
     * @since 4.3.2
     */
     ...
     *             if the attribute does not exist or if it is not of the
     *             expected type
     */
     ...
     * array of strings.
     * <p>
     * If the value stored under the specified {@code attributeName} is a
     * string, it will be wrapped in a single-element array before returning it.
     * 
     * @param attributeName
     *            the name of the attribute to get; never {@code null} or empty
     * @return the value
     ...
     *            the name of the attribute to get; never {@code null} or empty
     * @param annotationType
     *            the expected annotation type; never {@code null}
     ...
     * {@code attributeName}.
     * <p>
     * If the value stored under the specified {@code attributeName} is an
     * instance of {@code AnnotationAttributes}, it will be wrapped in a
     * single-element array before returning it.
     * <p>
     ...
     * <p>
     * If the value stored under the specified {@code attributeName} is an
     * {@code Annotation}, it will be wrapped in a single-element array before
     * returning it.
     * 
     * @param attributeName
     *            the name of the attribute to get; never {@code null} or empty
    ...
    /**
     * Get the value stored under the specified {@code attributeName}, ensuring
     * that the value is of the {@code expectedType}.
     * <p>
     * If the {@code expectedType} is an array and the value stored under the
     * specified {@code attributeName} is a single element of the component type
     * of the expected array type, the single element will be wrapped in a
     * single-element array of the appropriate type before returning it.
     * 
     * @param attributeName
     *            the name of the attribute to get; never {@code null} or empty
     * @param expectedType
     *            the expected type; never {@code null}
     * @return the value
     * @throws IllegalArgumentException
     *             if the attribute does not exist or if it is not of the
     *             expected type
    ...
    private <T> T getRequiredAttribute(String attributeName, Class<T> expectedType) {
        Assert2.hasText(attributeName, "'attributeName' must not be null or empty");
    ...
    private void assertAttributePresence(String attributeName, Object attributeValue) {
        Assert2.notNull(attributeValue, () -> String.format("Attribute '%s' not found in attributes for annotation [%s]",
    ...
    private void assertNotException(String attributeName, Object attributeValue) {
        if (attributeValue instanceof Throwable) {
            throw new IllegalArgumentException(
                    String.format("Attribute '%s' for annotation [%s] was not resolvable due to exception [%s]", attributeName,
    ...
    private void assertAttributeType(String attributeName, Object attributeValue, Class<?> expectedType) {
        if (!expectedType.isInstance(attributeValue)) {
            throw new IllegalArgumentException(String.format(
                    "Attribute '%s' is of type %s, but %s was expected in attributes for annotation [%s]", attributeName,
                    attributeValue.getClass().getSimpleName(), expectedType.getSimpleName(), this.displayName));
        }
    }
    ...
    private String valueToString(Object value) {
        ...
        if (value instanceof Object[]) {
            return "[" + StringUtils2.arrayToDelimitedString((Object[]) value, ", ") + "]";
        }
     ...
     * <p>
     * If the map is already an {@code AnnotationAttributes} instance, it will
     * be cast and returned immediately without creating a new instance.
     * Otherwise a new instance will be created by passing the supplied map to
     * the {@link #AnnotationAttributes(Map)} constructor.
     * 
     * @param map
     *            original source of annotation attribute <em>key-value</em>
     *            pairs
