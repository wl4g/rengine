 ...
 * a source such as a {@link Class} or {@link Method}.
 *
 * <p>
 ...
 * from} any Java {@link AnnotatedElement}. They may also be used for sources
 * that don't use reflection (such as those that directly parse bytecode).
 *
 * <p>
 ...
 * example, {@link SearchStrategy#TYPE_HIERARCHY} will search both superclasses
 ...
 *
 * // get all ExampleAnnotation declarations (including any meta-annotations)
 * // and
 ...
 * designed for composable annotations in Spring's common component model, with
 ...
 * standard Java reflection or Spring's {@link AnnotationUtils} for simple
...
public interface MergedAnnotations extends Iterable<MergedAnnotation<Annotation>> {
     ...
     * 
     * @param annotationType
     *            the fully qualified class name of the annotation type to check
     * @return {@code true} if the annotation is present
     */
     ...
     *            the annotation type to get
     * @param predicate
     *            a predicate that must match, or {@code null} if only type
     ...
     * 
     * @param annotationType
     *            the fully qualified class name of the annotation type to get
     * @return a {@link MergedAnnotation} instance
     */
     ...
     * type.
     * <p>
     * The resulting stream follows the same ordering rules as
     * {@link #stream()}.
     * 
     * @param annotationType
     ...
     * 
     * @param annotationType
     *            the fully qualified class name of the annotation type to match
     * @return a stream of matching annotations
     */
     ...
     * {@linkplain MergedAnnotation#getAggregateIndex() aggregate index} and
     * then by the annotation distance (with the closest annotations first).
     * This ordering means that, for most use-cases, the most suitable
     * annotations appear earliest in the stream.
     * 
     ...
     *            the repeatable containers that may be used by the element
     ...
     *            an annotation filter used to restrict the annotations
     *            considered
     * @return a {@code MergedAnnotations} instance containing the merged
    ...
    static MergedAnnotations from(
        ...
        Assert2.notNull(repeatableContainers, "RepeatableContainers must not be null");
        Assert2.notNull(annotationFilter, "AnnotationFilter must not be null");
     ...
     * 
     * @param source
     *            the source for the annotations. This source is used only for
     ...
     *            the annotations to include
     * @param repeatableContainers
     *            the repeatable containers that may be used by meta-annotations
     * @return a {@code MergedAnnotations} instance containing the annotations
     */
     ...
     *
     * <p>
     * Each strategy creates a different set of aggregates that will be combined
     * to create the final {@link MergedAnnotations}.
     */
    enum SearchStrategy {
         ...
         * <p>
         * This strategy is only really useful when used with {@link Class}
         * types since the {@link Inherited @Inherited} annotation is ignored
         * for all other {@linkplain AnnotatedElement annotated elements}.
         * <p>
         ...
         * {@link #TYPE_HIERARCHY}.
         * <p>
         * <strong>WARNING:</strong> This strategy searches recursively for
         ...
         * nested class, or a nested interface. Thus, it may find more
         * annotations than you would expect.
         */
