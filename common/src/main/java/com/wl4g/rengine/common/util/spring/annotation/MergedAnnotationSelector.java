...
public interface MergedAnnotationSelector<A extends Annotation> {
    ...
    /**
     * Determine if the existing annotation is known to be the best candidate
     * and any subsequent selections may be skipped.
     * 
     * @param annotation
     ...
     * 
     * @param existing
     *            an existing annotation returned from an earlier result
     * @param candidate
     *            a candidate annotation that may be better suited
