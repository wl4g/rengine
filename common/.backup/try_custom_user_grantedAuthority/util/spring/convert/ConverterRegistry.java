...
public interface ConverterRegistry {
    ...
    /**
     * Add a plain converter to this registry. The convertible source/target
     * type pair is derived from the Converter's parameterized types.
     * 
    ...
    /**
     * Add a plain converter to this registry. The convertible source/target
     * type pair is specified explicitly.
     * <p>
     ...
     * source/target type pair is derived from the ConverterFactory's
     * parameterized types.
     * 
     * @throws IllegalArgumentException
     *             if the parameterized types could not be resolved
