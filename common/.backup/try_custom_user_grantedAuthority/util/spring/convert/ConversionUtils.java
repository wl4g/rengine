...
abstract class ConversionUtils {
    ...
    public static boolean canConvertElements(
        ...
        if (ClassUtils2.isAssignable(sourceElementType.getType(), targetElementType.getType())) {
            // maybe
            return true;
        }
        // no
    ...
    public static Class<?> getEnumType(Class<?> targetType) {
        ...
        Assert2.notNull(enumType, () -> "The target type " + targetType.getName() + " does not refer to an enum");
        return enumType;
    }
