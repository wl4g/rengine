...
public interface Ordered {
     ...
     * <p>
     * Higher values are interpreted as lower priority. As a consequence, the
     * object with the lowest value has the highest priority (somewhat analogous
     * to Servlet {@code load-on-startup} values).
     * <p>
