...
public abstract class RepeatableContainers {
    ...
    public boolean equals(@Nullable Object other) {
        ...
        return ObjectUtils2.nullSafeEquals(this.parent, ((RepeatableContainers) other).parent);
    }

    @Override
    public int hashCode() {
        return ObjectUtils2.nullSafeHashCode(this.parent);
    }
     ...
     * 
     * @param repeatable
     *            the contained repeatable annotation
     * @param container
     *            the container annotation or {@code null}. If specified, this
     *            annotation must declare a {@code value} attribute returning an
     *            array of repeatable annotations. If not specified, the
     *            container will be deduced by inspecting the
     *            {@code @Repeatable} annotation on {@code repeatable}.
     * @return a {@link RepeatableContainers} instance
     */
    ...
    private static class StandardRepeatableContainers extends RepeatableContainers {
        ...
        Annotation[] findRepeatedAnnotations(Annotation annotation) {
            ...
            if (method != null) {
                return (Annotation[]) ReflectionUtils2.invokeMethod(method, annotation);
            }
    ...
    private static class ExplicitRepeatableContainer extends RepeatableContainers {
        ...
        ExplicitRepeatableContainer(@Nullable RepeatableContainers parent, Class<? extends Annotation> repeatable,
            ...
            super(parent);
            Assert2.notNull(repeatable, "Repeatable must not be null");
            if (container == null) {
            ...
            try {
                ...
                if (!returnType.isArray() || returnType.getComponentType() != repeatable) {
                    throw new AnnotationConfigurationException("Container type [" + container.getName()
                            + "] must declare a 'value' attribute for an array of type [" + repeatable.getName() + "]");
                }
            } catch (AnnotationConfigurationException ex) {
                throw ex;
            } catch (Throwable ex) {
                throw new AnnotationConfigurationException("Invalid declaration of container type [" + container.getName()
        ...
        private Class<? extends Annotation> deduceContainer(Class<? extends Annotation> repeatable) {
            ...
            Assert2.notNull(annotation, () -> "Annotation type must be a repeatable annotation: "
        ...
        Annotation[] findRepeatedAnnotations(Annotation annotation) {
            if (this.container.isAssignableFrom(annotation.annotationType())) {
                return (Annotation[]) ReflectionUtils2.invokeMethod(this.valueMethod, annotation);
            }
            return super.findRepeatedAnnotations(annotation);
        }
