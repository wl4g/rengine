...
import com.wl4g.rengine.client.eventbus.config.RabbitMQEventBusProperties;
...
@CustomLog
@AllArgsConstructor
public class RabbitmqEventBusService implements RengineEventBusService<Void>, InitializingBean {

    private final RengineEventBusProperties eventBusConfig;
    private final RabbitMQEventBusProperties rabbitmqEventConfig;
