...
public class UserInfo {
    ...
    public UserInfo(@Nullable @JsonProperty("status") Status status, @Nullable @JsonProperty("secretKey") String secretKey,
            @Nullable @JsonProperty("policyName") String policyName, @Nullable @JsonProperty("memberOf") List<String> memberOf) {
        this.status = status;
