...
/**
 * MinIO <a href=
 * "https://github.com/minio/madmin-go/blob/main/encrypt.go#L38">encrypts/decrypts</a>
 * any payloads containing access or secret keys. The encryption scheme used is
 * from a library called
 * <a href="https://github.com/secure-io/sio-go">sio-go</a>. The library
...
public class Crypto {
     ...
     * original implementation in Go, check out the <a href=
     * "https://github.com/minio/madmin-go/blob/main/encrypt.go#L38">madmin-go
     * library</a>.
     *
     * @param password
     *            Plaintext password
